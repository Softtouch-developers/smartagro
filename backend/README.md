...
## 🔌 API Endpoints
See [API endpoints](documentation/backend/openapi.json) for detailed breakdown of all endpoints.
...
- [Architecture Diagrams](./documentation/diagrams/) - PlantUML diagrams
